...
def create_driver_timeline(timeline_data, race_order):
...
career_timeline_data = pd.read_json('../data/career_timeline_data_1030.json')
with open('../data/race_order.json', 'r') as f:
    race_order = json.load(f)

dashboard = create_driver_timeline(career_timeline_data, race_order)
dashboard.show()